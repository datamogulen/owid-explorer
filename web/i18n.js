...
const SPRAK = {
  sv: {
    ...
    halKort: "pinnhål (mm)",
    halTitel: "Hål genom polerna för en pinne, borrat direkt i exporten. Måttet gäller den färdiga globen (~250 mm). 0 = inget hål.",
  ...
  en: {
    ...
    halKort: "pin hole (mm)",
    halTitel: "Hole through the poles for a stick, bored directly in the export. Measured on the finished globe (~250 mm). 0 = no hole.",
