...
const SPRAK = {
  sv: {
    ...
    halPa: "pinnhål i STL", halDiam: "håldiameter (mm)",
    ...
    halDiamTitel: "Måttet gäller den FÄRDIGA globen (~250 mm), inte exportfilens 100 mm — annars hade siffran varit missvisande.",
    minOTitel: "Öar smalare än så här utesluts ur STL:en — nålar knäcks vid rensning. Måttet gäller en färdig glob på 250 mm.",
  ...
  en: {
    ...
    halPa: "pin hole in STL", halDiam: "hole diameter (mm)",
    ...
    halDiamTitel: "Measured on the FINISHED globe (~250 mm), not the export file's 100 mm — otherwise the number would mislead.",
    minOTitel: "Islands narrower than this are left out of the STL — thin spikes snap off. Measured on a finished 250 mm globe.",
